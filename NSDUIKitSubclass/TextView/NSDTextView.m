...
#import "NSDTextView.h"

CGFloat const kNSDTextViewPlaceholderVerticalMargin = 8.0; ///< placeholder垂直方向边距
CGFloat const kNSDTextViewPlaceholderHorizontalMargin = 6.0; ///< placeholder水平方向边距

@interface NSDTextView ()
/**
 @brief 文本改变Block
 */
@property (nonatomic, copy) NSDTextViewHandler changeHandler;
/**
 @brief 达到最大限制字符数Block
 */
@property (nonatomic, copy) NSDTextViewHandler maxHandler;
/**
 @brief placeholderLabel
 */
@property (nonatomic, strong) UILabel *placeholderLabel;

@end

@implementation NSDTextView
...
- (void)initialize
{
    ...
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeTop
                                                    multiplier:1.0
                                                      constant:kNSDTextViewPlaceholderVerticalMargin]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeLeft
                                                    multiplier:1.0
                                                      constant:kNSDTextViewPlaceholderHorizontalMargin]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeWidth
                                                    multiplier:1.0
                                                      constant:-kNSDTextViewPlaceholderHorizontalMargin*2]];
    [self addConstraint:[NSLayoutConstraint constraintWithItem:self.placeholderLabel
                                                     ...
                                                     attribute:NSLayoutAttributeHeight
                                                    multiplier:1.0
                                                      constant:-kNSDTextViewPlaceholderVerticalMargin*2]];
}
...
- (void)nsd_AddTextDidChangeHandler:(NSDTextViewHandler)changeHandler
{
